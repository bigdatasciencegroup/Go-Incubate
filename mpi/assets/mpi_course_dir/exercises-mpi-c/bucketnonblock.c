...
/**** your code here ****/
  ...
  int
    error = fabs( (my_sum_of_squares - myvalue)/myvalue ) > 1.e-12 ? procno : nprocs,
    errors=-1;
  if (error)
    printf("[%d] myvalue %ld should be %ld\n",procno,(long)myvalue,(long)my_sum_of_squares);
